...
class ConfigManager:
    def __init__(self, config_dir: Optional[str] = None, config_name: Optional[str] = None):
        self.config_dir = Path(config_dir or os.getenv('CONFIG_DIR', '/default/config/dir'))
        self.config_name = config_name or os.getenv('CONFIG_NAME', 'config.json')
